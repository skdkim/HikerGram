...
Photo.create(image_url: "http://res.cloudinary.com/skdkim/image/upload/c_scale,w_600/v1478324523/philh.lee/photo-1471921152622-ee4bff0a0238_dzelit.jpg",
  ...
  description: "It is easier to feel than to realize, or in any way explain, Yosemite grandeur.");
...
Photo.create(image_url: "http://res.cloudinary.com/skdkim/image/upload/c_scale,w_600/v1478324282/johnmuir/photo-1415650328328-1909c4ceabdb_f21col.jpg",
  user_id: User.find_by(username: "johnmuir").id,
  description: "Rocks and waters, etc., are words of God, and so are men. We all flow from one fountain Soul.");
...
Photo.create(image_url: "http://res.cloudinary.com/skdkim/image/upload/c_scale,w_600/v1478324337/johnmuir/photo-1443636695178-be226c44e060_gzhvpw.jpg",
  user_id: User.find_by(username: "johnmuir").id,
  description: "Take a course in good water and air; and in the eternal youth of Nature you may renew your own.");
...
Like.create(photo_id: 31, user_id: 1);
Like.create(photo_id: 32, user_id: 1);
Like.create(photo_id: 33, user_id: 1);
Like.create(photo_id: 34, user_id: 1);
Like.create(photo_id: 35, user_id: 1);
Like.create(photo_id: 36, user_id: 1);
Like.create(photo_id: 37, user_id: 1);
Like.create(photo_id: 38, user_id: 1);
Like.create(photo_id: 39, user_id: 1);
Like.create(photo_id: 40, user_id: 1);
...
Like.create(photo_id: 31, user_id: 2);
Like.create(photo_id: 32, user_id: 2);
Like.create(photo_id: 33, user_id: 2);
Like.create(photo_id: 34, user_id: 2);
Like.create(photo_id: 35, user_id: 2);
Like.create(photo_id: 36, user_id: 2);
Like.create(photo_id: 37, user_id: 2);
Like.create(photo_id: 38, user_id: 2);
Like.create(photo_id: 39, user_id: 2);
Like.create(photo_id: 40, user_id: 2);
...
Like.create(photo_id: 31, user_id: 4);
Like.create(photo_id: 32, user_id: 4);
Like.create(photo_id: 33, user_id: 4);
Like.create(photo_id: 34, user_id: 4);
Like.create(photo_id: 35, user_id: 4);
Like.create(photo_id: 36, user_id: 4);
Like.create(photo_id: 37, user_id: 4);
Like.create(photo_id: 38, user_id: 4);
Like.create(photo_id: 39, user_id: 4);
Like.create(photo_id: 40, user_id: 4);
...
Like.create(photo_id: 31, user_id: 5);
# Like.create(photo_id: 32, user_id: 5);
Like.create(photo_id: 33, user_id: 5);
# Like.create(photo_id: 34, user_id: 5);
Like.create(photo_id: 35, user_id: 5);
# Like.create(photo_id: 36, user_id: 5);
Like.create(photo_id: 37, user_id: 5);
# Like.create(photo_id: 38, user_id: 5);
Like.create(photo_id: 39, user_id: 5);
# Like.create(photo_id: 40, user_id: 5);
...
Like.create(photo_id: 31, user_id: 6);
Like.create(photo_id: 32, user_id: 6);
Like.create(photo_id: 33, user_id: 6);
Like.create(photo_id: 34, user_id: 6);
Like.create(photo_id: 35, user_id: 6);
Like.create(photo_id: 36, user_id: 6);
Like.create(photo_id: 37, user_id: 6);
Like.create(photo_id: 38, user_id: 6);
Like.create(photo_id: 39, user_id: 6);
Like.create(photo_id: 40, user_id: 6);
...
Like.create(photo_id: 31, user_id: 8);
Like.create(photo_id: 32, user_id: 8);
Like.create(photo_id: 33, user_id: 8);
Like.create(photo_id: 34, user_id: 8);
Like.create(photo_id: 35, user_id: 8);
Like.create(photo_id: 36, user_id: 8);
Like.create(photo_id: 37, user_id: 8);
Like.create(photo_id: 38, user_id: 8);
Like.create(photo_id: 39, user_id: 8);
Like.create(photo_id: 40, user_id: 8);
...
Like.create(photo_id: 31, user_id: 10);
Like.create(photo_id: 32, user_id: 10);
Like.create(photo_id: 33, user_id: 10);
Like.create(photo_id: 34, user_id: 10);
Like.create(photo_id: 35, user_id: 10);
Like.create(photo_id: 36, user_id: 10);
Like.create(photo_id: 37, user_id: 10);
Like.create(photo_id: 38, user_id: 10);
Like.create(photo_id: 39, user_id: 10);
Like.create(photo_id: 40, user_id: 10);
...
Comment.create(photo_id: 31, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 32, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 33, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
# Comment.create(photo_id: 34, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 35, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 36, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 37, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 38, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 39, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
Comment.create(photo_id: 40, user_id: 1, comment_text: "Nice picture! Keep up the great work!");
...
Comment.create(photo_id: 18, user_id: 5, comment_text: "What a clear lake!");
Comment.create(photo_id: 19, user_id: 2, comment_text: "Nice night shot!");
Comment.create(photo_id: 20, user_id: 5, comment_text: "Those clouds look amazing!");
...
Comment.create(photo_id: 45, user_id: 9, comment_text: "You opted for the mist trail this time?");
Comment.create(photo_id: 46, user_id: 5, comment_text: "ND filter? Shutter speed? How did you take this shot?");
...
Comment.create(photo_id: 50, user_id: 5, comment_text: "I feel like I should know what plant this is but I don't...");
...
Comment.create(photo_id: 58, user_id: 5, comment_text: "Seasons are so wonderful!");
Comment.create(photo_id: 59, user_id: 3, comment_text: "Looks like a great spot for morning runs.");
Comment.create(photo_id: 60, user_id: 5, comment_text: "Found it! haha");
...
Comment.create(photo_id: 88, user_id: 5, comment_text: "Keep it up!");
...
Comment.create(photo_id: 93, user_id: 5, comment_text: "Pretty small pinecone bro..");
...
Comment.create(photo_id: 96, user_id: 5, comment_text: "But this one looks pretty hard to climb.. Probably not for you though Bear.");
...
Comment.create(photo_id: 100, user_id: 5, comment_text: "Yes please!");
